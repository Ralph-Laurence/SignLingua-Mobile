...
public class MyLearnersActivity extends AppCompatActivity implements FindLearnerJsBridge.FindLearnerJsBridgeListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        m_webView.loadUrl("file:///android_asset/pages/my_learners.html");
    ...
    {
        learnerMgtApiService.findLearners(page, search, disability, "friend").enqueue(new Callback<>()
        {
            @Override
            public void onResponse(Call<PaginatedResponse<LearnerItem>> call, Response<PaginatedResponse<LearnerItem>> response)
            {
                ...
                {
                    Intent intent = new Intent(MyLearnersActivity.this, GlobalCrashHandler.class);
    ...
    {
        runOnUiThread(() -> {
            Intent intent = new Intent(MyLearnersActivity.this, TutorHomeActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(intent);
        });
    }
    ...
    {
        runOnUiThread(() -> {
            Log.d("MINE", "Called from MY LEARNERS!");
            Intent intent = new Intent(MyLearnersActivity.this, LearnerDetailsActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            intent.putExtra("learnerId", id);
            intent.putExtra("launchedFrom", "myLearners");
            startActivity(intent);
            finish();
        });
    }
