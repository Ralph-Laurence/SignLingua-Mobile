...
public class TutorClassroomsActivity extends AppCompatActivity
        implements TutorClassroomsJsBridge.TutorClassroomsJsBridgeListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        m_webView.addJavascriptInterface(new TutorClassroomsJsBridge(this), JS_BRIDGE_NAME);

        m_webView.loadUrl("file:///android_asset/pages/tutor_classrooms.html");
    ...
    {
        runOnUiThread(() -> {
            Intent intent = new Intent(TutorClassroomsActivity.this, TutorHomeActivity.class);
    ...
    {
        tutorMgtApiService.fetchClassrooms().enqueue(new Callback<>()
        {
            @Override
            ...
            @Override
            public void onFailure(Call<TutorClassroomsResponse> call, Throwable t)
            {
