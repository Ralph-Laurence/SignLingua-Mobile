...
public class FindTutorsActivity extends AppCompatActivity implements FindTutorJsBridge.FindTutorJsBridgeListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        m_webView.setWebViewClient(new WebViewClient()
        {
            ...
            public void onPageFinished(WebView view, String url)
            {
                ...
                if (!url.equals(lastLoadedUrl))
                {
                    ...
                    runOnUiThread(() -> findTutors(null, 1, null));
                }
            }
        });
        ...
        m_webView.loadUrl("file:///android_asset/pages/find_tutors.html");

        // Initialize Retrofit API Service
        tutorMgtApiService = ApiClient.getClient(this, true).create(TutorManagementApiService.class);
    }

    private void findTutors(String search, int page, String disability)
    {
        tutorMgtApiService.findTutors(page, search, disability, "new").enqueue(new Callback<>()
        {
            @Override
    ...
    {
        runOnUiThread(() -> {
            Intent intent = new Intent(FindTutorsActivity.this, LearnerHomeActivity.class);
    ...
    {
        runOnUiThread(() -> findTutors(search, page, disability));
    }
    ...
    public void onStalkProfile(String id)
    {
        runOnUiThread(() -> {
            ...
            intent.putExtra("launchedFrom", "findTutors");
            startActivity(intent);
            finish();
        });
    }
