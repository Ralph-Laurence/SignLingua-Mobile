...
const descriptions = [
    "Classrooms allow tutors to host one-on-one video sessions with you, providing you with a personalized learning experience.",
    "Connect with your tutor in a Classroom, where you can schedule one-on-one video sessions for focused learning and mentorship.",
    "In Classrooms, tutors can arrange one-on-one video sessions with you, ensuring personalized guidance and a structured learning experience.",
    "Classrooms give you direct access to your tutor, offering personalized video sessions that support your learning style and preferences.",
    "Your tutor can schedule one-on-one video sessions, giving you a dedicated space for personalized learning and mentorship."
];
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    $('#btn-back').on("click", function () {
        ...
        if (window.LearnerClassroomsJsBridge) {
            window.LearnerClassroomsJsBridge.onGoBack();
        }
    });
